      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid md:grid-cols-2 gap-12 md:gap-20 items-center">
          <div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 animate-on-scroll stagger-3">
              <a
                href="mailto:hello@graphigo.studio"
              ...
              <div className="relative bg-card rounded-2xl p-8 md:p-10 border border-border">
                ...
                <div className="space-y-6">
                  <div>
                    ...
                    <a href="mailto:hello@graphigo.studio" className="text-lg hover:text-accent transition-colors">
                      hello@graphigo.studio
                    </a>
                  </div>
        ...
        <div className="mt-24 pt-8 border-t border-border flex flex-col md:flex-row items-center justify-between gap-4 animate-on-scroll">
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold">GRAPHIGO</span>
          </div>
          <p className="text-muted-foreground text-sm">© 2026 Graphigo Studios. All rights reserved.</p>
        </div>
      </div>
    </section>
  )
