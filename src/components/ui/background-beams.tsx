...
export const BackgroundBeams = React.memo(
    ({ className }: { className?: string }) => {
        ...
        // Color palette for randomized beams
        const colorPalette = [
            { start: "#ff6b35", mid: "#f7931e", end: "#ffb347" }, // Orange
                ...
                >
                    ...
                    <defs>
                        {paths.map((path, index) => (
                            ...
                            >
                                <stop stopColor={pathColors[index].start} stopOpacity="0"></stop>
                                <stop stopColor={pathColors[index].start}></stop>
                                <stop offset="32.5%" stopColor={pathColors[index].mid}></stop>
                                <stop offset="100%" stopColor={pathColors[index].end} stopOpacity="0"></stop>
                            </motion.linearGradient>
                        ))}
